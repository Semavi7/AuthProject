        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    PhoneVerifyId = table.Column<Guid>(type: "uuid", nullable: true),
                    EmailVerifyId = table.Column<Guid>(type: "uuid", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_Socialites", x => x.Id);
                    table.ForeignKey(
                        name: "FK_Socialites_users_UserId",
                        column: x => x.UserId,
                        principalTable: "users",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    NeighBourhood = table.Column<Guid>(type: "uuid", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<Guid>(type: "uuid", nullable: false),
                    UserId = table.Column<Guid>(type: "uuid", nullable: false),
                    VerifyId = table.Column<Guid>(type: "uuid", nullable: false),
                    ExpireAt = table.Column<DateTime>(type: "timestamp with time zone", nullable: false),
                    IsUsedAt = table.Column<DateTime>(type: "timestamp with time zone", nullable: true)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_ForgetPasswords", x => x.Id);
                    table.ForeignKey(
                        name: "FK_ForgetPasswords_Verifies_VerifyId",
                        column: x => x.VerifyId,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ForgetPasswords_VerifyId",
                table: "ForgetPasswords",
                column: "VerifyId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Socialites_Type_RefId",
                table: "Socialites",
                columns: new[] { "Type", "RefId" },
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_Socialites_UserId",
                table: "Socialites",
                column: "UserId");
